...
enum LetterLibrary {
    ...
    static let lowercaseAndNumbers: [LetterGlyph] = [
        ...
        LetterGlyph(character: "s", exampleWord: "sun", family: .specials, strokes: [
            stroke([
                (0.68, 0.42), (0.63, 0.37), (0.55, 0.34), (0.45, 0.33),
                (0.34, 0.35), (0.26, 0.40), (0.22, 0.46), (0.23, 0.51),
                (0.29, 0.56), (0.39, 0.59), (0.50, 0.61), (0.60, 0.64),
                (0.67, 0.69), (0.69, 0.74), (0.67, 0.78), (0.61, 0.82),
                (0.52, 0.84), (0.42, 0.84), (0.33, 0.82), (0.26, 0.78),
                (0.21, 0.72)
            ])
        ]),
